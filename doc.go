...
/*
Package scribe implements a PDF document generator with high level
...
scribe-go has no dependencies other than the Go standard library. All tests
...
for the application to transfer the error to the Scribe instance by
calling the SetError() method or the SetErrorf() method. At any time
during the life cycle of the Scribe instance, the error state can be
...
example PDFs. These can be found in the scribe-go/pdf directory after the
tests complete.
...
generate output in different forms. It uses scribe-go for its document
production mode.

# License

scribe-go is released under the MIT License. It is copyrighted by Kurt Jung
...
independently of scribe-go. Paul also added support for page boxes used in
...
*/
package scribe // import "github.com/kofi-q/scribe-go"
